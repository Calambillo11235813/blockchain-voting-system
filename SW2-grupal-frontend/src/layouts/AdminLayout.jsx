...
const SIDEBAR_ITEMS = [
  ...
  { key: 'consolidacion', label: 'Consolidación de Resultados', to: '/admin/consolidacion-resultados', rolesRequeridos: ['ELECTORAL'] },
  ...
  { key: 'despliegue', label: 'Desplegar Contratos', to: '/admin/despliegue-contratos', rolesRequeridos: ['SISTEMAS'] },
]
