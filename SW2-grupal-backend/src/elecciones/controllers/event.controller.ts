...
export class EventController {
  ...
  findAll(
    ...
    return this.eventService.findAll(req.userId, paginationDto);
  }
  ...
  findOne(
    ...
    return this.eventService.findOne(id, req.userId);
  }
  ...
  create(
    ...
    return this.eventService.create({ ...createEventDto, faculty: facultyResult.entity }, files, req.userId);
  }
  ...
  patch(
    ...
    return this.eventService.patch(id, updateEventDto, files, req.userId);
  }
  ...
  remove(
    ...
    return this.eventService.remove(id, req.userId);
  }
  ...
  findByFaculty(
    ...
    return this.eventService.findByFaculty(facultyId, req.userId, paginationDto);
  }

  @Get('statistics/tenant')
  getEventStatistics(@Req() req: Request) {
    return this.eventService.getEventStatistics(req.userId);
  }
