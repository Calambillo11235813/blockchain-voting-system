...
export class TicketController {
    ...
    findAll(
        ...
        return this.ticketService.findAll(req.userId, paginationDto);
    }
    ...
    findBySection(
        ...
        return this.ticketService.findBySection(sectionId, req.userId, paginationDto);
    }
    ...
    findOne(
        ...
        return this.ticketService.findOne(id, req.userId);
    }
    ...
    remove(
        ...
        return this.ticketService.remove(id, req.userId);
    }
    ...
    getTicketStatistics(@Req() req: Request) {
        return this.ticketService.getTicketStatistics(req.userId);
    }
}