...
export class SectionController {
    ...
    findAll(
        ...
        return this.sectionService.findAll(req.userId, paginationDto);
    }
    ...
    findAllSectionByEvent(
        ...
        return this.sectionService.findAllSectionByEvent(eventId, req.userId, paginationDto);
    }
    ...
    findOne(
        ...
        return this.sectionService.findOne(id, req.userId);
    }
    ...
    patch(
        ...
        return this.sectionService.patch(id, updateSectionDto, req.userId);
    }
    ...
    remove(
        ...
        return this.sectionService.remove(id, req.userId);
    }
    ...
    getSectionStatistics(
        ...
        return this.sectionService.getSectionStatistics(eventId, req.userId);
    }
    ...
    updateTicketPrices(
        ...
        return this.sectionService.updateTicketPrices(id, updateTicketPriceDto, req.userId);
    }
    ...
    createTickets(
        ...
        return this.sectionService.createTickets(id, quantity, req.userId);
    }
}